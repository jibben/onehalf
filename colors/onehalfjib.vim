...
let s:red         = { "gui": "#c5431b", "cterm": "168" }
let s:green       = { "gui": "#41ad33", "cterm": "114" }
let s:yellow      = { "gui": "#edcc8e", "cterm": "180" }
let s:blue        = { "gui": "#509be6", "cterm": "75"  }
let s:purple      = { "gui": "#c678dd", "cterm": "176" }
let s:cyan        = { "gui": "#5ec4d1", "cterm": "73"  }
let s:brown        = { "gui": "#d1732c", "cterm": "130"  }
let s:white       = { "gui": "#dddddd", "cterm": "253" }

let s:fg          = s:white
let s:bg          = s:black

let s:comment_fg  = { "gui": "#71798a", "cterm": "241" }
...
call s:h("Statement", s:brown, "", "")

call s:h("Conditional", s:brown, "", "")
call s:h("Repeat", s:brown, "", "")
call s:h("Label", s:purple, "", "")
call s:h("Operator", s:brown, "", "")
